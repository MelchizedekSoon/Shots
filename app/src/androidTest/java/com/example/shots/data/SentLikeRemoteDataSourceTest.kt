...
class SentLikeRemoteDataSourceTest {
    ...
    fun setUp() = runTest {
        ...
        sentLikeRemoteDataSource =
            FakeSentLikeRemoteDataSourceImpl(
                firebaseAuth,
                firebaseFirestore,
                sentLikeDao
            )
    ...
    fun writeReceivedLikeToFirebase() = runTest {
        ...
        assertTrue(
            sentLikeRemoteDataSource.writeSentLikeToFirebase(
                "Ron",
                sentLikeData
            )
        )
    ...
    fun getReceivedLikesFromFirebase() = runTest {
        val sentLikeData = mutableMapOf<String, Any>()
        sentLikeData["sentLike-Lon"] = "Lon"
        sentLikeRemoteDataSource.writeSentLikeToFirebase("John", sentLikeData)
        assertTrue(sentLikeRemoteDataSource.getSentLikesFromFirebase("John").isNotEmpty())
    }
    ...
    fun removeReceivedLikeFromFirebase() = runTest {
        val sentLikeData = mutableMapOf<String, Any>()
        sentLikeRemoteDataSource.writeSentLikeToFirebase("John", sentLikeData)
        assertTrue(sentLikeRemoteDataSource.removeSentLikeFromFirebase("John"))
    }
