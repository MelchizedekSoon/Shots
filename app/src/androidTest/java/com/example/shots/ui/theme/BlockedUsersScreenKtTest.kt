...
//        val blockedUserLocalDataSource: BlockedUserLocalDataSource = mockk(relaxed = true)
//        val blockedUserRemoteDataSource: BlockedUserRemoteDataSource = mockk(relaxed = true)
//        val blockedUserRepository = FakeBlockedUserRepositoryImpl()
//        blockedUserViewModel = BlockedUserViewModel(blockedUserRepository)
//
////            val userWhoBlockedYouLocalDataSource: UserWhoBlockedYouLocalDataSource =
////                UserWhoBlockedYouLocalDataSource(
//        //    val userWhoBlockedYouRemoteDataSource: UserWhoBlockedYouRemoteDataSource
//
//
//        user = User(
//            "Rick",
...
//
//        every { userViewModel.getUser() } returns user
//
////        every { userViewModel.fetchUserFromRoom(user.id) } returns user
//
//        every {
...
//
////        every {
////            blockedUserViewModel.fetchBlockedUsers()
////        } returns blockedUsers
//
