    ...
    override suspend fun getUsers(): List<User> {
        return try {
            ...
            for (doc in docRef) {
                ...
                Log.d("UserRemoteDataSourceImplImpl", "User retrieved - $user")
                users.add(user)
            }
            users
        } catch (e: Exception) {
            Log.d(
                "UserRemoteDataSourceImplImpl",
    ...
    override suspend fun getUserData(userId: String): User? {
        try {
            ...
            try {
                ...
                Log.d("UserRemoteDataSourceImplImpl", "Here is the value for document - $document")
                if (document.exists()) {
                    ...
                    if (userData != null) {
                        ...
                        try {
                            ...
                            Log.e(
                                "UserRemoteDataSourceImpl",
                                "Invalid userName value: $userNameValue"
                            )
                        }
                        ...
                        try {
                            ...
                            Log.e(
                                "UserRemoteDataSourceImpl",
                                "Invalid latitude value: $latitudeValue"
                            )
                        ...
                        try {
                            ...
                            Log.e(
                                "UserRemoteDataSourceImpl",
                                "Invalid longitude value: $longitudeValue"
                            )
                            // Handle the error appropriately
                        }
                        ...
                        try {
                            ...
                            Log.e(
                                "UserRemoteDataSourceImpl",
                                "Invalid birthday value: ${birthdayValue}" +
                                        " - ${e.message}"
                            )
                        }
                        ...
                        try {
                            ...
                            Log.e(
                                "UserRemoteDataSourceImpl",
                                "Invalid mediaOne value: ${mediaOneValue}"
                            )
                        }
                        Log.d("UserRemoteDataSourceImpl", "mediaOne upon return - $mediaOne")
                        ...
                        try {
                            ...
                            Log.e(
                                "UserRemoteDataSourceImpl",
                                "Invalid mediaTwo value: ${mediaTwoValue}"
                            )
                        }
                        ...
                        try {
                            ...
                            Log.e(
                                "UserRemoteDataSourceImpl",
                                "Invalid mediaSix value: ${mediaSixValue}"
                            )
                        }
                        ...
                        try {
                            ...
                            Log.e(
                                "UserRemoteDataSourceImpl",
                                "Invalid gender value: ${genderValue}"
                            )
                        }
                        ...
                        try {
                            ...
                            Log.e(
                                "UserRemoteDataSourceImpl",
                                "Invalid aboutMe value: ${aboutMeValue}"
                            )
                        }
                        ...
                        try {
                            ...
                            Log.e("UserRemoteDataSourceImpl", "Invalid link value: ${linkValue}")
                        }
                        ...
                        try {
                            ...
                            Log.e(
                                "UserRemoteDataSourceImpl",
                                "Invalid height value: ${heightValue}"
                            )
                        }
                        ...
                        try {
                            ...
                            Log.e("UserRemoteDataSourceImpl", "Invalid work value: ${workValue}")
                        }
...
//                            e.message?.let { Log.e("UserRemoteDataSourceImpl"", it) }
//                            Log.e("UserRemoteDataSourceImpl"", "Invalid education value: $educationValue")
//                            null
//                        }
//                    } else {
//                        // Handle the case where lookingForValue is null
//                        // For example, you might want to set a default value or log a message
//                        Log.d("UserRemoteDataSourceImpl"", "education value is null")
//                        null
//                    }
                        ...
                        try {
                            ...
                            Log.e(
                                "UserRemoteDataSourceImpl", " Invalid kids value : $ { kidsValue }"
                            )
                        }
                        ...
                        try {
                            ...
                            Log.e(
                                "UserRemoteDataSourceImpl",
                                "Invalid religion value: ${religionValue}"
                            )
                        }
                        ...
                        try {
                            ...
                            Log.e("UserRemoteDataSourceImpl", "Invalid pets value: ${petsValue}")
                        }
                        ...
                        try {
                            ...
                            Log.e(
                                "UserRemoteDataSourceImpl",
                                "Invalid exercise value: ${exerciseValue}"
                            )
                        }
                        ...
                        try {
                            ...
                            Log.e(
                                "UserRemoteDataSourceImpl",
                                "Invalid smoking value: ${smokingValue}"
                            )
                        }
                        ...
                        try {
                            ...
                            Log.e(
                                "UserRemoteDataSourceImpl",
                                "Invalid drinking value: ${drinkingValue}"
                            )
                        }
...
//                            )
                        ...
                        try {
                            ...
                            Log.e(
                                "UserRemoteDataSourceImpl",
                                " Invalid showMe value : $ { showMeValue }"
                            )
                        }
...
//                    }
                        ...
                        Log.d("UserRemoteDataSourceImpl", "religion upon return - $religion")
                        ...
                        Log.d("UserRemoteDataSourceImpl", "Missing required fields in user data")
                    }
                } else {
                    Log.d("UserRemoteDataSourceImpl", "User document does not exist")
                }
            } catch (e: Exception) {
                e.printStackTrace()
                Log.d("UserRemoteDataSourceImpl", "Error fetching user data: $e - ${e.message}")
            }
        } catch (e: Exception) {
            Log.d("UserRemoteDataSourceImpl", "Error fetching user data: ${e.message}")
        }
        return null
    }
            ...
            uri.let { validUri ->
                if (validUri.toString() == "") {
                    ...
                    try {
                        ...
                        Log.d("UserRemoteDataSourceImpl", "The file's added type is $type")
                        when (mediaIdentifier) {
                        ...
                        Log.d("UserRemoteDataSourceImpl", "File successfully added to storage")
...
//            val userDataWithoutMedia = userData.filterKeys { !it.startsWith("media") }
            ...
            Log.d("UserRemoteDataSourceImpl", "userId = $userId")
            firebaseFirestore.collection("users").document(userId)
                .set(userDataWithMediaUrls, SetOptions.merge()).await()
            Log.d("UserRemoteDataSourceImpl", "User content successfully added")
            true // Success
        } catch (e: Exception) {
            Log.d("UserRemoteDataSourceImpl", "User content was not added ${e.message}")
            false // Error
        }
    }
